...
void MainWindow::displayChampionDetails()
{
    ...
    for (int i=0; i<mcl.count(); i++)
    {
                    ...
                    && myChampTags[QString::fromStdString(mcl[i].getName())].contains(ui->tagFilterComboBox->currentText()) ))
        {
            ...
            j++;
            ui->championsTableWidget->setItem(nextOpenIndex, j, new QTableWidgetItem( QString::number(mcl[i].getKills()) ));
            j++;
            ui->championsTableWidget->setItem(nextOpenIndex, j, new QTableWidgetItem( QString::number(mcl[i].getDeaths()) ));
            j++;
            ui->championsTableWidget->setItem(nextOpenIndex, j, new QTableWidgetItem( QString::number(mcl[i].getAssists()) ));
            j++;
            ui->championsTableWidget->setItem(nextOpenIndex, j, new QTableWidgetItem( QString::number(mcl[i].KDA()) ));
            j++;
            ui->championsTableWidget->setItem(nextOpenIndex, j, new QTableWidgetItem( QString::number(mcl[i].getWins()) ));
            j++;
            ui->championsTableWidget->setItem(nextOpenIndex, j, new QTableWidgetItem( QString::number(mcl[i].getLosses()) ));
            j++;
            ui->championsTableWidget->setItem(nextOpenIndex, j, new QTableWidgetItem( QString::number(mcl[i].winRate(0)) ));
            j++;
            ui->championsTableWidget->setItem(nextOpenIndex, j, new QTableWidgetItem( QString::number(mcl[i].getBlueWins()) ));
            j++;
            ui->championsTableWidget->setItem(nextOpenIndex, j, new QTableWidgetItem( QString::number(mcl[i].getBlueLosses()) ));
            j++;
            ui->championsTableWidget->setItem(nextOpenIndex, j, new QTableWidgetItem( QString::number(mcl[i].getPurpleWins()) ));
            j++;
            ui->championsTableWidget->setItem(nextOpenIndex, j, new QTableWidgetItem( QString::number(mcl[i].getPurpleLosses()) ));
            j++;
            ui->championsTableWidget->setItem(nextOpenIndex, j, new QTableWidgetItem( QString::number(mcl[i].winRate(2)) ));
            j++;
            ui->championsTableWidget->setItem(nextOpenIndex, j, new QTableWidgetItem( QString::number(mcl[i].getCreepScore()) ));
            j++;
            ui->championsTableWidget->setItem(nextOpenIndex, j, new QTableWidgetItem( QString::number(mcl[i].getNeutralCreeps()) ));
            j++;
            ui->championsTableWidget->setItem(nextOpenIndex, j, new QTableWidgetItem( QString::number(mcl[i].getEnemyMinions()) ));
            j++;
            ui->championsTableWidget->setItem(nextOpenIndex, j, new QTableWidgetItem( QString::number(mcl[i].averages(0)) ));
            j++;
            ui->championsTableWidget->setItem(nextOpenIndex, j, new QTableWidgetItem( QString::number(mcl[i].averages(1)) ));
            j++;
            ui->championsTableWidget->setItem(nextOpenIndex, j, new QTableWidgetItem( QString::number(mcl[i].averages(2)) ));
